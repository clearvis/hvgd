...
add_image_size( 'joints-thumb-150', 150, 50, true );
/*
...
function joints_register_sidebars() {
	...
	register_sidebar(array(
		'id' => 'contact-sidebar',
		'name' => __('Contact', 'jointstheme'),
		'description' => __('Contact Sidebar.', 'jointstheme'),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h4 class="widgettitle">',
		'after_title' => '</h4>',
    ...
    //Home page Testimonials Sidebar
	register_sidebar(array(
		'id' => 'testimonials',
		'name' => __('Testimonials', 'jointstheme'),
		'description' => __('Testimonials Sidebar.', 'jointstheme'),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget' => '</div>',
		'before_title' => '<h4 class="widgettitle">',
		'after_title' => '</h4>',
