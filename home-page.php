				    ...
				    <div id="main" class="large-12 medium-12 columns" role="main">
                        ...
                        <div class="row home-blocks-container">
                          <div class="large-12 columns">
                            ...
                            <div class="row home-blocks-container">
                                <div class="medium-4 columns home-widget-container">
                                    <div class="flex-video"><?php if (!function_exists('dynamic_sidebar') || !dynamic_sidebar('Homeleft')) : endif; ?></div>
                                </div>
                                ...
                                <div class="medium-4 columns home-widget-container">                                   
                                    <div class="flex-video"><?php if (!function_exists('dynamic_sidebar') || !dynamic_sidebar('Homeright')) : endif; ?></div>                                    
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="medium-6 columns">
                                    <?php if (!function_exists('dynamic_sidebar') || !dynamic_sidebar('testimonials')) : endif; ?>
                                </div>
